...
import Inventory_Manager.InventoryFrame;


public class Sales_Manager02 extends javax.swing.JFrame {

    public Sales_Manager02() {
        initComponents();
    }
    ...
    private void btnReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReportActionPerformed
        ViewReport02 viewReportFrame = new ViewReport02();
    ...
    private void btnRequsitionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequsitionActionPerformed
        CreateRequisition02 createRequisitionFrame = new CreateRequisition02();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sales_Manager02.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sales_Manager02().setVisible(true);
            }
        });
    }
